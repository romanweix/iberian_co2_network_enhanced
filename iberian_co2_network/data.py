...
SCO2_PHASE = True # supercritical phase (True), liquid phase (False)
...
ONSHORE_INSULATION_SURCHARGE_PCT = 40 # e.g. 20 -> insulated pipe costs 20% more per inch than uninsulated
