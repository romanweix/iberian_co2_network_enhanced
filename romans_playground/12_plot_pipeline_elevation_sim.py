...
for idx, row in df.iterrows():
    ...
    temp_ds = xr.open_dataset("era5_july_mean_last5years.nc",
                                  engine="netcdf4")
    ...
    temp_static = 318.15  # Temperature in Kelvin (25 °C)
...
file_path = "sim_pipeline_candidates_supercritical_july.xlsx"
